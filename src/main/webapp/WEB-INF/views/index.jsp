			...
			function buy(id){
				$.ajax({
					...
					success:function(data){
						if(data == "IsAjax"){
							window.location.href = "/ms2/login/toLogin.do";
						}else if(data == true){
				...
				<div class="banner_box auto">
					...
					<div class="side_bar">
						<ul>
							<c:forEach items="${courseDirections}" var="courseDirection">
								<li>
									<a href="/ms2/main/toCourse.do?courseDirectionId=${courseDirection.id}&courseContentId=0">
				...
				<div class="column auto autoH">
					...
					<c:forEach items="${demoCourses}" var="demoCourse">
						<div class="course_box">
							<a href="/ms2/main/toVideo.do?courseId=${demoCourse.id}" >
							...
							<div>
								...
								<p class="price">
									<span>¥${demoCourse.price}</span>
									<span class="right buy" onclick="buy(${demoCourse.id});">点击购买</span>
								</p>
			...
			<!-- column -->
				<div class="column auto autoH">
					...
					<c:forEach items="${newCourses}" var="newCourse">
						<div class="course_box">
							<a href="/ms2/main/toVideo.do?courseId=${newCourse.id}" >
							...
							<div>
								...
								<p class="level">实战 初级</p>
								<p class="price">
									<span>¥${newCourse.price}</span>
									<span class="right buy" onclick="buy(${newCourse.id});">点击购买</span>
								</p>
