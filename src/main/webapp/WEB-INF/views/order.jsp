	...
	<head>
		...
		<script type="text/javascript">
			function order(){
				...
				document.location.href = "/ms2/main/order.do?itemIds="+itemIds;
			}
		</script>
			...
			<div class="auto">
				...
				<div class="order_pic order_check">	
					...
					<div class="bottom">
						...
						<p><a href="/ms2/main/toCar.do">返回购物车</a><a href="javascript:order();"><span>提交订单</span></a></p>
